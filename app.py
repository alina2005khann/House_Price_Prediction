...
## Steps to run 
# 1.project folder
# 2.all code paste in projct folder
# 3.run the app.py --- CMD ----> python app.py
# 4. upload in github
#          ---> commands run in CMD

# git config --global user.name "alina"   -----> sets name 
# git config --global user.email "alina2005khann@gmail.com"   --->sets email
